...
if (!_tb_dis) {
    ...
    var _pmpmk = pm_ppy + '/pmk-202010011.2.js';
    var _pmasync = true;
    ...
    'sx': '(//div[@class="ac-breadcrumb "]/ol/li[contains(@class,"ac-icon")]/a)[last()]',
    'at': '//div[contains(@class,"date")]//a',
    'ncnsnt': true
};
var _tb_vpx = [{
    'xpath': '//figure[contains(@class,"iframe")]//iframe[contains(@src,"video")]',
     'attr': 'iframe'
}];
